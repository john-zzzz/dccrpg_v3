...
export const critTables = {
	1: {
		...
		1: {
			text: 'Opportunistic strike. Inflict +1d3 damage with this strike.',
			rolls: [{ name: 'Additional Damage', number: 1, die: dice.d3 }],
		},
		2: {
			text: 'Foe jabbed in the eye! Ugly bruising and inflict +1d4 damage with this strike.',
		...
		5: {
			text: 'Solid strike to torso. Inflict +1d6 damage with this strike.',
			rolls: [{ name: 'Additional Damage', number: 1, die: dice.d6 }],
		},
		6: { text: 'Lucky strike disarms foe. You gain a free attack if the enemy stoops to retrieve his weapon.' },
		7: {
			text: "Smash foe's hand. Inflict +2d3 damage with this strike. You break two of the enemy's fingers.",
			rolls: [{ name: 'Additional Damage', number: 2, die: dice.d3 }],
		},
		8: { text: 'Numbing strike! Cursing in agony, the foe is unable to attack next round.' },
		9: {
			text: "Smash foe's nose. Inflict +2d4 damage with this strike and blood streams down the enemy's face.",
			rolls: [{ name: 'Additional Damage', number: 2, die: dice.d4 }],
		},
		10: { text: 'Foe trips on his own feet and falls prone for the remainder of the round.' },
		11: {
			text: 'Piercing strike. Inflict +2d4 damage with this strike.',
			rolls: [{ name: 'Additional Damage', number: 2, die: dice.d4 }],
		},
		...
		14: {
			text: 'Strike grazes temple; blood blinds the foe for 1d3 rounds.',
			rolls: [{ name: 'Blind for x Rounds', number: 1, die: dice.d3 }],
		},
		15: {
			text: "Stab enemy's weapon hand. The weapon is lost and knocked 1d10+5 feet away.",
			rolls: [{ name: 'Weapon knocked x Feet away', number: 1, die: dice.d10 }],
		},
		16: {
			result:
		...
		18: {
			text: ' Foe falls into your attack. He takes +2d6 damage from the strike and curses your luck.',
		...
		20: {
			text: "Lucky blow dents foe's skull! Inflict +2d6 damage with this strike",
			rolls: [{ name: 'Additional Damage', number: 2, die: dice.d6 }],
		},
	},
	2: {
		...
		1: {
			text: 'Strike misses critical organs. Inflict a paltry +2d3 damage with this strike.',
			rolls: [{ name: 'Reduce Damage to x', number: 2, die: dice.d3 }],
		},
		2: {
			text: "Slashes to head removes foe's ear. Inflict +1d6 damage with this strike and leave the enemy with a nasty scar.",
		},
		3: {
			text: 'Clean strike to back. Inflict +2d6 damage with this strike.',
			rolls: [{ name: 'Additional Damage', number: 2, die: dice.d6 }],
		},
		...
		7: {
			text: 'Strike to chest grazes vital organ. Inflict +3d4 damage with this strike.',
			rolls: [{ name: 'Additional Damage', number: 3, die: dice.d4 }],
		},
		8: {
			text: "Strike cuts a line down foe's face. He is blinded by blood for 1d4 rounds.",
			rolls: [{ name: 'Blinded for x rounds', number: 1, die: dice.d4 }],
		},
		9: { text: 'Foe stumbles over his own limbs, falling prone. Make another attack.' },
		10: {
			text: 'Masterful strike! Inflict +2d6 damage with this strike.',
			rolls: [{ name: 'Additional Damage', number: 2, die: dice.d6 }],
		},
		...
		13: {
			text: 'Foe disoriented by quick strikes. Foe suffers a -4 penalty to attack rolls for 1d4 rounds.',
			rolls: [{ name: '-4 Penalty for x rounds', number: 1, die: dice.d4 }],
		},
		14: { text: 'Strike to head. Foe must make a Fort save (DC 10 + PC level) or fall unconscious' },
		15: {
			text: 'Blow drives foe to ground. Inflict +2d6 damage with this strike, and the enemy is knocked prone.',
			rolls: [{ name: 'Additional Damage', number: 2, die: dice.d6 }],
		},
		16: {
	...
	3: {
		...
		3: {
			text: 'Foe steps into attack. Inflict +1d8 damage with this strike.',
			rolls: [{ name: '', number: 1, die: dice.d8 }],
		},
		...
		12: {
			text: 'Blow to cranium staggers foe. The foe must make a Fort save (10 + PC level) or sink to floor, unconscious.',
		},
		13: {
		...
		14: {
			text: "Attack hammers foe's torso. Inflict +2d8 damage with this strike.",
		...
		19: {
			text: 'Devastating strike to the chest. Inflict +2d8 damage with this strike.',
			rolls: [{ name: 'Additional Damage', number: 2, die: dice.d8 }],
		},
		20: {
		...
		22: {
			text: 'Weapon arm sundered by strike. The weapon is lost along with any chance of making an attack with this arm.',
		},
		23: {
		...
		25: {
			text: 'Attack punches shattered ribs through lungs. Foe loses 50% of his remaining hit points and vomits copious amounts of blood.',
		},
		26: {
	...
	4: {
		...
		1: {
			text: 'Herculean blow. Inflict +2d12 damage with this strike.',
		...
		6: {
			text: "Strike shatters foe's breastbone. The foe must make a Fort save (DC 15 + PC level) or fall unconscious as his internal organs collapse.",
		},
		7: {
		...
		14: {
			text: 'Blow to spinal column numbs lower limbs. The foe suffers a -4 penalty to AC as he learns to walk again.  ',
		},
		15: {
		...
		19: {
			text: 'Strike to weapon arm. Foe takes triple damage from his own weapon as it is hammered into his face. Foe drops weapon in dumbfounded awe.',
		},
		20: {
			result:
	...
	5: {
		...
		4: {
			text: 'Strike to gut! The foe must make a Fort save (DC 20 + PC level) or spend the next 2 rounds retching bile from a ruptured stomach.',
		},
		5: {
		...
		16: {
			text: "Strike to top of skull shortens spinal column, shortening foe by 6”. Resulting nerve damage reduces foe's AC by -4.",
		},
		17: { text: 'Target is disemboweled, spilling his entrails onto the ground. Foe dies instantly of shock.' },
		18: {
			text: "Blow destroys target's face. Foe is immediately rendered blind and deaf and is now capable of only wet, gurgling sounds.",
		},
		19: {
		...
		25: {
			text: "Devastating strike to torso voids foe's bowels and crushes organs into paste.  Foe loses 50% of current hit points and all dignity.",
		},
		26: {
		...
		28: {
			text: "Foe decapitated with a single strike. You are Death incarnate. Continue to make attacks against any foes within 10' until you miss",
		},
		29: {
			text: "Foe decapitated with a single strike. You are Death incarnate. Continue to make attacks against any foes within 10' until you miss",
		},
